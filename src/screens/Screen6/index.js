        ...
        <KeyboardAvoidingView
            ...
            <ImageBackground source={require('../../img/bg_blur.png')} style={styles.image}>
                ...
                <View style={[viewstyle, {top: 40}]}>
                    <Text style={[textstyle, {paddingLeft: 40,paddingRight: 40}]}>How important is it that your partner’s height is close to your own?</Text>
                    <View style={{
