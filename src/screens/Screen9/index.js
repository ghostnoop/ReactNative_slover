        ...
        <KeyboardAvoidingView
            ...
            <ImageBackground source={require('../../img/bg_blur.png')} style={styles.image}>
                ...
                <View style={[viewstyle, {top: 40}]}>
                    <Text style={[textstyle, {paddingLeft: 40,paddingRight: 40}]}>Socially, do you feel more comfortable in small circles
                        or in larger groups?
                    </Text>
                    <View style={{
                        ...
                        <TouchableOpacity style={[btntoch]} onPress={() => NEXT(navigation)}>
                            <Text style={[{}, datestyle]}>Small circles</Text>
                        </TouchableOpacity>

                        <TouchableOpacity style={[btntoch]} onPress={() => NEXT(navigation)}>
                            <Text style={datestyle}>Larger groups</Text>
                        </TouchableOpacity>

                        <TouchableOpacity style={[btntoch]} onPress={() => NEXT(navigation)}>
                            <Text style={datestyle}>I don't really mind either way</Text>
                        </TouchableOpacity>
